...
This repository contains the JIPipe pipeline used for analyzing β‑sheet fluorescence in microscopy images
...
This repository contains an image analysis pipeline built with JIPipe 6.0.0 and Python for processing microscopy data. The workflow requires the JIPipe Basic plugin, which must be installed via the ImageJ Update Manager before running the pipeline.
